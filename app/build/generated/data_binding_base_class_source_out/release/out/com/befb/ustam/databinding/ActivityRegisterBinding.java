...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  @NonNull
  public final RadioButton musteriRadioButton;
  ...
  @NonNull
  public final RadioButton ustaRadioButton;

  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextInputEditText emailEditText, @NonNull ImageView imageView3,
      @NonNull RadioButton musteriRadioButton, @NonNull TextInputEditText nameEditText,
      ...
      @NonNull TextView registerTextView, @NonNull TextInputLayout textInputLayout,
      @NonNull TextInputLayout textInputLayout2, @NonNull RadioButton ustaRadioButton) {
    this.rootView = rootView;
    this.emailEditText = emailEditText;
    this.imageView3 = imageView3;
    this.musteriRadioButton = musteriRadioButton;
    ...
    this.ustaRadioButton = ustaRadioButton;
  }
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.musteriRadioButton;
      RadioButton musteriRadioButton = ViewBindings.findChildViewById(rootView, id);
      if (musteriRadioButton == null) {
        break missingId;
      }
      ...
      id = R.id.ustaRadioButton;
      RadioButton ustaRadioButton = ViewBindings.findChildViewById(rootView, id);
      if (ustaRadioButton == null) {
        break missingId;
      }

      return new ActivityRegisterBinding((ConstraintLayout) rootView, emailEditText, imageView3,
          musteriRadioButton, nameEditText, nameInputLayout, passwordEditText, phoneEditText,
          phoneInputLayout, radioGroup, registerButton, registerTextView, textInputLayout,
          textInputLayout2, ustaRadioButton);
    }
