...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextInputEditText emailEditText, @NonNull ImageView imageView4,
      @NonNull TextView kdTextView, @NonNull Button loginButton,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.kdTextView;
      TextView kdTextView = ViewBindings.findChildViewById(rootView, id);
      if (kdTextView == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, emailEditText, imageView4,
          kdTextView, loginButton, passwordEditText, registerButton, textInputLayout,
          textInputLayout2);
    }
